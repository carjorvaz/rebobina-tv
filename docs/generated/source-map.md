...
`REBOBINA_SOURCE_MAP_DATE=2026-06-03 scripts/generate-source-map docs/generated/source-map.md`.
...
| `docs/VALIDATION.md` | 173 | Validation commands and when to run them. |
